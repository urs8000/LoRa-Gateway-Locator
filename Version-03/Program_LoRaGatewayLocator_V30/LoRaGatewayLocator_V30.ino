 ...
 *  
 *  Tested with: Arduino 1.6.7 & Teensyduino on Win10 
 *  in your final compillation you should disable DEBUG1 and set GPSdebug FALSE so the code will be smaller and more efficient
 *  
 *  Hardware:  
 *  - Teensy 3.2
 *  - RFM95W  from Hoperf.nl  (compatible with SX1272)
 *  - u-blox PAM-7Q  sponsored by u-blox
 *  - OLED (blue or white) with connectors: GND - VCC - SCL - SDA  
...
// define OLED
Adafruit_ssd1306syp display(SDA,SCL);      // for Teensy3.2  ********
